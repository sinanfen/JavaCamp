...
public class Main {
	...
	public static void main(String[] args) {
		Instructor instructor1 = new Instructor(1,"Engin","Demiroğ","C#");
		Instructor instructor2 = new Instructor(1,"Engin","Demiroğ","Java");
		Instructor instructor3 = new Instructor(1,"Engin","Demiroğ","Python");
